...
class SPIMemIO(Peripheral, Elaboratable):
    ...
    Attributes
    ----------
    data_bus : :class:`amaranth_soc.wishbone.Interface`
        Wishbone bus interface, directly mapped read-only flash memory.
    ctrl_bus : :class:`amaranth_soc.wishbone.Interface`
        Wishbone bus interface that splits the orignal 32-bit control
        register over 4 8-bit CSRs.
    """
