...
struct spiflash_model {
    std::string name;
    spiflash_model(const std::string &name, const uint8_t *clk, const uint8_t *csn, const uint8_t *d_o, const uint8_t *d_oe, uint8_t *d_i) : 
...
struct uart_model {
    std::string name;
    uart_model(const std::string &name, const uint8_t *tx, uint8_t *rx, unsigned baud_div = 25000000/115200) : name(name), tx(tx), rx(rx), baud_div(baud_div) {};
...
struct gpio_model {
    ...
    std::string name;
    gpio_model(const std::string &name, const uint8_t *o, const uint8_t *oe, uint8_t *i) : name(name), o(o), oe(oe), i(i) {};
